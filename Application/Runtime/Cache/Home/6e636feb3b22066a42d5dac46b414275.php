		 ...
		 <div id="right" style="width:65%;height:800px;float:left;">
			<div style="width:100%;height:800px;background-color:#DFEDFC;margin:20px auto;overflow-y:auto;overflow-x:hidden;">
				<?php if(is_array($blog)): foreach($blog as $key=>$vo): ?><div>
					<div>
						<div style="display:inline;"><?php echo ($vo["username"]); ?>----<?php echo ($vo["time"]); ?></div>
						...
						<?php if(($vo["userid"]) == $_SESSION['userid']): else: ?>
							...
							<?php if($vo["isrepeat"] == 1): ?><div><?php echo ($vo["ps"]); ?></div>
							<?php else: endif; ?>
				...
				<div style="width:100%;height:140px;margin:0 auto;position:relative;">
					...
					<div style="background-color:#EAF3FC;border-style:solid;border-width:1px; width:95%;height:80px;overflow-y:auto;overflow-x:hidden;">
